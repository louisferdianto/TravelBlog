<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Location.aspx.cs" Inherits="XMLWSAssg.EndUser.Location" %>
...
<body  style="width:600px; height:100%; margin: 0 auto;  background-color:transparent; background-image: url('../bg4.jpg'); background-attachment:fixed;" >
  ...
  <a class="nav-link active" href="Home.aspx">MyBlog</a>
    ...
    <form id="form1" runat="server">
        <!-- Header -->
        <div class="jumbotron">
                    <asp:Xml ID="xmlLocation" runat="server" DocumentSource="~/App_Data/AdminPost.xml" TransformSource="~/App_Data/LocationBased.xsl"></asp:Xml>
        </div><br /><br />
    </form>
</body>
</html>
